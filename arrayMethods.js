...
// // CODE HERE
// const totalPopulation = populations.reduce((accumulator, currentVal) => accumulator + currentVal);
...
//   Instead of just arrays of numbers, we are going to have arrays of objects that we want to use map, filter, and reduce with.
...
// const withTax = orders.map(element => element.price * (1 + element.tax))
...
// const bobsTotal = purchases.filter(element => element.owner === 'Bob').reduce((accumulator, currentVal) => accumulator + currentVal.price, 0)
